...
export class SimpleScratchCardComponent {
  ...
  canvasInit() {
    ...
    console.log(this.ctx, "canvasElement")
  ...
  canvasImageLoad(): Promise<any> {
    ...
    const img = 'https://cdn.glitch.com/4c9ebeb9-8b9a-4adc-ad0a-238d9ae00bb5%2Fmdn_logo-only_color.svg?1535749917189';
 ...
 */
  ...
  scratching = this.throttle((event: any) => {
